    ...
    def _register(
        ...
        *,
        ...
        snapshot = {
            ...
            "entry_tree": candidate.entry_tree.as_dict(),
            "exit_tree": candidate.exit_tree.as_dict() if candidate.exit_tree else None,
            "stop": candidate.stop.as_dict() if candidate.stop else None,
            "target": candidate.target.as_dict() if candidate.target else None,
            "sizing": candidate.sizing.as_dict() if candidate.sizing else None,
            "regime_gates": [g.as_dict() for g in candidate.regime_gates],
